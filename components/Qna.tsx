    ...
    questions: [
      {
        ...
        answer: "Yes. Password recovery is one of our most common services. Using advanced decryption methods, custom algorithms, and AI-powered tools, we can often recover wallets with forgotten passwords. Success depends on factors like password complexity and wallet type, but our specialists have recovered thousands of password-protected wallets.",
      },
      {
        question: "What if I only have part of my seed phrase?",
        answer: "We can help! If you have most of your 12 or 24-word recovery phrase (typically 8+ words), our seed phrase reconstruction service can often recover the missing words using advanced computational techniques. The more words you have, the higher the success probability. Contact us for a free assessment of your specific situation.",
      },
      {
...
const FAQ = () => {
  ...
  return (
    ...
    >
      ...
      {/* Gradient orbs */}
      <div className="absolute top-1/4 right-0 w-64 h-64 sm:w-96 sm:h-96 bg-blue-500/10 rounded-full blur-3xl" aria-hidden="true" />
      <div className="absolute bottom-1/4 left-0 w-64 h-64 sm:w-96 sm:h-96 bg-purple-500/10 rounded-full blur-3xl" aria-hidden="true" />
      ...
      <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <header className="text-center mb-12 sm:mb-16 md:mb-20">
          <div className="inline-flex items-center gap-2 rounded-full border border-blue-500/20 bg-blue-500/10 px-3 py-1.5 sm:px-4 sm:py-2 backdrop-blur-sm mb-4 sm:mb-6">
            <HelpCircle className="w-3 h-3 sm:w-4 sm:h-4 text-blue-400" aria-hidden="true" />
            <span className="text-xs sm:text-sm text-blue-300 font-medium">Got Questions?</span>
          </div>
          ...
          <p className="text-sm sm:text-base md:text-lg text-white/60 max-w-3xl mx-auto">
            Everything you need to know about our cryptocurrency wallet recovery services. 
          ...
          {faqs.map((category, categoryIndex) => (
            <div key={categoryIndex}>
              ...
              <div className="mb-4 sm:mb-6">
                ...
                <div className="h-1 w-16 sm:w-20 bg-gradient-to-r from-blue-400 to-purple-400 rounded-full mt-2 sm:mt-3" aria-hidden="true" />
              </div>
                    ...
                    >
                      ...
                      >
                        ...
                        <div className="flex-shrink-0 mt-1">
                          ...
                          `}>
                            {isOpen ? (
                              <Minus className="w-3 h-3 sm:w-4 sm:h-4 text-blue-400" aria-hidden="true" />
                            ) : (
                              <Plus className="w-3 h-3 sm:w-4 sm:h-4 text-blue-400" aria-hidden="true" />
                            )}
                          </div>
                        </div>
                      </button>
          ...
          <div className="relative rounded-2xl sm:rounded-3xl overflow-hidden border border-white/10 bg-gradient-to-br from-blue-500/10 via-purple-500/10 to-pink-500/10 backdrop-blur-sm p-6 sm:p-8 md:p-10">
            ...
            <div className="relative text-center">
              <div className="inline-flex items-center justify-center w-12 h-12 sm:w-16 sm:h-16 rounded-full bg-gradient-to-br from-blue-500/20 to-purple-500/20 border border-white/10 mb-4 sm:mb-6">
                <MessageCircle className="w-6 h-6 sm:w-8 sm:h-8 text-blue-400" aria-hidden="true" />
              </div>
              ...
              <p className="text-sm sm:text-base text-white/60 mb-6 sm:mb-8 max-w-2xl mx-auto">
                Our recovery specialists are available 24/7 to answer your questions and provide 
                a free consultation for your specific case.
              </p>
